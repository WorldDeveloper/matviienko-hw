  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <h2>List of trains passing station "Minsk"</h2>
        <table>
          <tr>
            <th>Train ID</th>
            <th>Arrival Time</th>
        ...
        <h2>List of trains passing station "Vinnytsa"</h2>
        <table>
          <tr>
            <th>Train ID</th>
            <th>Arrival Time</th>
        ...
        <h2>List of stations being passed by train "24"</h2>
        <table>
          <tr>
            <th>Station</th>
            <th>Arrival Time</th>
        ...
        <h2>List of stations being passed by train "106"</h2>
        <table>
          <tr>
            <th>Station</th>
            <th>Arrival Time</th>
