...
Menu::Menu(char *name, const char size, const char* items[], const int xCoord, const int yCoord)
:mItemsNumber(size),  mX(xCoord), mY(yCoord)
{
	int itemMaxLen = 0;
